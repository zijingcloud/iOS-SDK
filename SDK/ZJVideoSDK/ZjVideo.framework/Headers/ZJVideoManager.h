...
@property(nonatomic, copy) NSString *mcuServer;
...
/**
 *  实现功能 : 设置Api Server (接口地址)
 *  默认使用公有云API服务地址，如果使用私有云API服务地址，请使用此方法设置
 */
- (void)setApiServer:(NSString *)apiServer;

/**
 *  实现功能 : 设置Mcu Server (接口地址)
 *  默认使用公有云MCU服务地址，如果使用私有云MCU服务地址，请使用此方法设置
 */
- (void)setMcuServer:(NSString *)mcuServer;

/**
 *  实现功能 : 设置Voip token (推送服务标识)
 */
